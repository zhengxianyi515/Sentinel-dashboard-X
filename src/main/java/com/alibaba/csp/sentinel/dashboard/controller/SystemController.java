...
import com.alibaba.csp.sentinel.dashboard.repository.rule.DatabaseSystemRuleStore;
...
public class SystemController {
    ...
    @Autowired
    private DatabaseSystemRuleStore repository;
    @Autowired
...
//            List<SystemRuleEntity> rules = sentinelApiClient.fetchSystemRuleOfMachine(app, ip, port);
    ...
    @AuthAction(PrivilegeType.WRITE_RULE)
    public Result<SystemRuleEntity> apiUpdateIfNotNull(Long id, String app, String ip, Integer port, Double highestSystemLoad,
