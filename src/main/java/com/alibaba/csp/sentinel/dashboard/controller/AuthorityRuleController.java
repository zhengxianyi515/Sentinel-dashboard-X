...
import com.alibaba.csp.sentinel.dashboard.repository.rule.DatabaseAuthorityRuleStore;
...
public class AuthorityRuleController {
    ...
    @Autowired
    private DatabaseAuthorityRuleStore repository;
...
//        }
    ...
    public Result<Long> apiDeleteRule(@PathVariable("id") Long id) {
        ...
        AuthorityRuleEntity entity = repository.findById(id);
        if (entity == null) {
