...
@Import({NoAuthConfigurationTest.class, DataSource.class, SqlSessionFactory.class, InMemGatewayFlowRuleStore.class, AppManagement.class, SimpleMachineDiscovery.class})
